    ...
    <div className="content">
      <div className="block1">
        <div className="block1_left">
          <p className="font-black  mb-2" style={{ color: "#A5A582" }}>
            ABOUT US
          </p>
          <h1 className="bord">
          ...
          <div className="col-6">
            <div className="blockUs2_wrapper_left">
              ...
              <div className="blockUs2_subtitle2">
                <img src="blockUs2-subtitle.png" alt="" />
              </div>
              <div className="blockUs2_subtitle2-mobile">
                <img src="blockUs2-subtitle-mobile.png" alt="" />
              </div>
            </div>
          </div>
          <div className="col-6">
            <div className="left_bottom_block">
              <div className="block1_desc">
                ...
                <div className="rating_block bord">
                  <img src="/block1Stars.png" alt="" />
                  <p>95% of clients recommend us</p>
                </div>
                <div className="mass_block bord">
                  <img src="/Google.png" alt="" style={{ objectFit: "contain" }} />
                  <img src="/Facebook.png" alt="" style={{ objectFit: "contain" }} />
                  <img src="/Yelp.png" alt="" style={{ objectFit: "cover" }} />
                </div>
              </div>
            </div>
          </div>
