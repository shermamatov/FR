...
export default function ReviewsBlock2({ services }: any) {
    ...
    useEffect(() => {
        if (reviewsAll) {
            setVideoReviewsAll(
                reviewsAll.filter((item) => item.video !== null)
            );
        }
    }, [reviewsAll]);
                        ...
                        videoReviewsAll?.map((item) => (
                            <div key={item.id}>
                                ...
                                {modal && (
                                    ...
                                    >
                                        <div
                                            className="relative flex justify-center flex-col h-[60vh] sm:h-[90vh] "
                                            onClick={(e) => e.stopPropagation()}
                                        >
                                            <img
                                            ...
                                            <video
                                                className="reviewsBlock2_card_img h-[auto] max-h-[450px]"
                                                controls
                                            >
                                                <source
                                                    src={`${review.video}`}
