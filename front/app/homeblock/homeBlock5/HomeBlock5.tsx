            ...
            <div className="services__inner">
              <div className="services__top">
                ...
                <p className="services__desc bord">
                  ...
                  provide high-quality content to website visitors and be an
                  authoritative thought leader in the industry; creating new,
                  highly-useful content for the blog and landing pages; focusing
                  on on-page optimizations targeting high-value search-terms.
                </p>
              </div>
