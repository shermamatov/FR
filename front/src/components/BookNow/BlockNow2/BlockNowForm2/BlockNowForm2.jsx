...
const BlockNowForm2 = ({ changeLocalStorage }) => {
  ...
  return (
    <div className="blockNowForm2">
      ...
      <h2 className="blockNowForm2_time">Select time for Monday, February 20</h2>
      ...
      <textarea placeholder="Comment" className="blockNowForm2_textarea"></textarea>
      <button onClick={()=>{
        changeLocalStorage(false)
      }} className="blockNowForm2_btn">Book now</button>
    </div>
  );
};
