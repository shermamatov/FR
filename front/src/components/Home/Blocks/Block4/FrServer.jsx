...
const FrServer = () => {
    ...
    <div className="fr_server">
        ...
        <div className="container">
            <h2 className="fr__title">OUR photos</h2>
            <div className="grid_block grid_block--none">
                <div className="grid__item">
                    <img src={grid_img} alt="" className="grid__img"/>
                    <p className="grid__desc">The unseen of spending three years at Pixelgrade, spending three years at</p>
                </div>
                <div className="grid__item">
                    <img src={grid_img} alt="" className="grid__img"/>
                    <p className="grid__desc">The unseen of spending three years at Pixelgrade, spending three years at</p>
            ...
            <div className={width < 850?"grid_block":"grid_block d-none"}>
                <div className="grid__item">
                    <img src={grid_img} alt="" className="grid__img"/>
                    <p className="grid__desc">The unseen of spending three years at Pixelgrade</p>
                </div>
                <div className="grid__item">
                    <img src={grid_img} alt="" className="grid__img"/>
                    <p className="grid__desc">The unseen of spending three years at Pixelgrade</p>
