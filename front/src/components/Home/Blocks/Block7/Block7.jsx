        ...
        <Slider {...settings}>
          {reviews.map((item) => (
            <div className="video_review_block_adap" key={item.id}>
              <img src={item.image1 ? item.image1 : img1} alt="" />
              <h5>{item.name}</h5>
              <div>
                <img src={rating} alt="" />
                <p>{item.stars}</p>
        ...
        <div className="video_left">
          <div className="video_left_block">
            {reviews && reviews.length > 0 ? (
              <>
                <img
                  src={reviews[0].image1 ? reviews[0].image1 : img1}
                  alt=""
                />
        ...
        <div className="video_right">
          {
            videoReviews.map(item =>{
              return  <div key={item.id} className="video_left_block">
              <img src={ item.image1 ? item.image1 : img3} alt="" />
              <h5>{item.name}</h5>
              <div>
                <img src={rating} alt="" />
                <p>{item.stars}</p>
