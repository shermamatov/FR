...
const ServBlock9 = ({ reviews }: any) => {
  ...
  useEffect(() => {
    setVideoReviews(
      reviews.results.filter((item: any) => item.video).slice(1, 5)
    );
  }, [reviews]);
              ...
              {reviews && reviews.results.length > 0 ? (
                <>
                  ...
                  <div>
                    <video>
                      <source
                        src={`${reviews.results[0].video || "/altVideo.mp4"}`}
                        type="video/mp4"
                      />
                      <source
                        src={`${reviews.results[0].video || "/altVideo.mp4"}`}
                    ...
                    <button
                      className="video_left_block_btn z-10"
                      onClick={() => openReviewModal(reviews.results[0])}>
                      Play video
                    </button>
                  </div>
