...
export default function ReviewsBlock2() {
    ...
    async function getData(limit = 4, offset = 0) {
        setReviews(await fetchReviews(limit, offset));
    }

    useEffect(() => {
        getData(4, 4 * currentPage);
    }, [currentPage]);
            ...
            <div className="content">
                <div className="reviewsBlock2_btns">
                    ...
                    >
                        ...
                        <div className="reviewsFilterPopup_block">
                            ...
                            <button className="reviewsFilterPopup_block_btn">
                                save
                            </button>
                        </div>
                    </div>
                ...
                <div className="paggination flex">
                    ...
                    <div className="flex pagg_numbers">
                        {getPaggPage(reviews?.count, 4).map((item: any) => (
                            <p
                    ...
                    <button
                        className={`next__btn btn ${
                            currentPage >= Math.ceil(reviews?.count / 4) - 1 &&
                            "noActive"
                        } `}
                        onClick={() => {
                            setCurrentPage(
